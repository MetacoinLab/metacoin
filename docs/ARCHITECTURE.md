...
>
> Chain point: tip index <!--chain:tip_index-->91<!--/chain-->, hash
> <!--chain:tip_hash_prefix-->8bfe198d7aa1<!--/chain-->…,
> <!--chain:entry_count-->92<!--/chain--> entries, genesis
> <!--chain:genesis_hash_prefix-->71fe94035edd<!--/chain-->….

The protocol's entire public state is one append-only hash chain of
<!--chain:entry_count-->92<!--/chain--> entries. Every layer described below is
...
now holds <!--chain:task_count-->29<!--/chain--> tasks and — since the idx
48-52 milestone batch, per the cadence policy — all
<!--chain:recorded_task_count-->29<!--/chain--> are recorded; between
...
<!--chain:recorded_task_count-->29<!--/chain--> recorded task outputs on
