...
>
> Chain point: tip index <!--chain:tip_index-->96<!--/chain-->,
> <!--chain:entry_count-->97<!--/chain--> entries.
...
- **chain+anchor** — the hash chain is intact from genesis
  ...
  <!--chain:tip_hash_prefix-->ae126922563f<!--/chain-->…, and the committed tip anchor
  matches. In a fresh clone the published snapshot is the source, and the
  report names that.
- **tasks** — all <!--chain:recorded_task_count-->31<!--/chain--> recorded
  demo tasks re-run to their canonical output hashes. The registry holds
  <!--chain:task_count-->31<!--/chain--> tasks in total; registry tasks not
...
`demo/run_all_selftests.sh` (<!--chain:demo_suite_count-->41<!--/chain-->
