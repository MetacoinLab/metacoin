...
| Chain point it describes | <!--chain:pulse_entries-->80<!--/chain--> entries, tip index <!--chain:pulse_tip_index-->79<!--/chain--> (<!--chain:pulse_entries_since-->29<!--/chain--> entries since) |
