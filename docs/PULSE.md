...
>
> Chain point: tip index <!--chain:tip_index-->93<!--/chain-->,
...
| Chain point it describes | <!--chain:pulse_entries-->80<!--/chain--> entries, tip index <!--chain:pulse_tip_index-->79<!--/chain--> (<!--chain:pulse_entries_since-->14<!--/chain--> entries since) |
