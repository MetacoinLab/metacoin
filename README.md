...
<p align="center"><img src="assets/hero.svg" width="100%" alt="MetaCoin hero banner: the tagline and motto beside the emblem over a deep-space field, and the lineage strip — gold, bitcoin, MetaCoin — with the lineage sentence; generated by protocol/hero_svg.py from the frozen identity text"></p>
