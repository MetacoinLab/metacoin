...
TESTS=(
    ...
    "tasks/task_0035_schema_migration_consistency.py"
    "tasks/task_0036_api_contract_satisfiability.py"
    "tasks/task_0037_dependency_resolution.py"
    "tasks/task_0038_config_consistency_audit.py"
    "tasks/task_0039_data_pipeline_reconciliation.py"
    "tasks/task_0040_test_coverage_gap.py"
    "verify_gates.py"
    "test_meta_faucet.py"
    "x402_spend_stub.py"
    "agent_loop.py"
